    ...
    <Dialog open={open} onClose={setOpen} className="relative z-10">
      ...
      <div className="fixed inset-0 z-10 w-screen overflow-y-auto">
        <div className="flex min-h-full items-stretch justify-center text-center md:items-center md:px-2 lg:px-4">
          ...
          >
            <div className="relative flex w-full items-center overflow-hidden rounded-md bg-white px-4 pb-8 pt-14 shadow-2xl md:p-6 lg:p-8 dark:bg-gray-900">
              <button
                type="button"
                onClick={() => setOpen(false)}
                className="absolute right-4 top-4 text-gray-400 hover:text-gray-500 md:right-6 md:top-6 lg:right-8 lg:top-8 dark:text-gray-100 dark:hover:text-gray-300"
              >
              ...
              <div className="grid w-full grid-cols-1 items-start gap-x-6 gap-y-8 md:grid-cols-12 lg:gap-x-8">
                <div className="aspect-h-3 aspect-w-2 h-full overflow-hidden rounded-lg md:col-span-4 lg:col-span-5">
                  {product.images && (
                    <img
                ...
                <div className="md:col-span-8 lg:col-span-7">
                  <h2 className="text-2xl font-bold text-gray-900 md:pr-12 dark:text-gray-100">
                    {product.name}
                  </h2>
                  ...
                  <section aria-labelledby="options-heading" className="mt-10">
                    ...
                    <form onSubmit={handleAddToCartSubmit}>
                        ...
                        >
                          {Object.entries(product.sizes).map(([size, inStock]) => (
                            <Radio
                              ...
                              disabled={!inStock}
                              className={twMerge(
                                'group relative flex items-center justify-center rounded-md border px-4 py-3 text-sm font-medium uppercase hover:bg-gray-50 focus:outline-none data-[focus]:ring-2 data-[focus]:ring-indigo-500 md:flex-1 dark:hover:bg-gray-700',
                                inStock
                      ...
                      <button
                        ...
                        className="mt-6 flex w-full items-center justify-center rounded-md border border-transparent bg-indigo-600 px-8 py-3 text-base font-medium text-white hover:bg-indigo-700 focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:ring-offset-2 disabled:cursor-not-allowed disabled:bg-indigo-400 dark:disabled:bg-indigo-900 dark:disabled:text-gray-500"
                      >
                        Add to cart
                      </button>
                    </form>
